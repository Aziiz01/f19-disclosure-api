    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_XbrlFacts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_XbrlFacts_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_XbrlFacts_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_TenantId_FiscalYear",
                table: "Reports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_XbrlFacts_ReportId_Concept",
                table: "XbrlFacts",
                columns: new[] { "ReportId", "Concept" });

            migrationBuilder.CreateIndex(
                name: "IX_XbrlFacts_TenantId",
                table: "XbrlFacts",
                column: "TenantId");
        }
